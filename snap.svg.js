...
Snap.plugin(function (Snap, Element, Paper, glob, Fragment) {
    ...
    (function () {
        ...
        function gradient(defs, str) {
            ...
            for (i = 0; i <= len;="" i++)="" {="" var="" stop="stops[i];" el.addstop(stop.color,="" stop.offset);="" }="" return="" el;="" function="" gradientlinear(defs,="" x1,="" y1,="" x2,="" y2)="" el="Snap._.make("linearGradient"," defs);="" el.stops="Gstops;" el.addstop="GaddStop;" el.getbbox="GgetBBox;" if="" (x1="" !="null)" $(el.node,="" x1:="" y1:="" x2:="" y2:="" y2="" });="" gradientradial(defs,="" cx,="" cy,="" r,="" fx,="" fy)="" (cx="" cx:="" cy:="" r:="" r="" (fx="" &&="" fy="" fx:="" fy:="" *\="" *="" paper.gradient="" [="" method="" ]="" **="" creates="" a="" gradient="" element="" -="" (string)="" descriptor=""> Gradient Descriptor
